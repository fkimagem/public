...
#if defined(DISP_BODMER)
        WidgetBase::objTFT->drawString(conteudo, pontoPreview.x + 2, pontoPreview.y + (pontoPreview.height / 2));
...
#if defined(DISP_BODMER)
                    int16_t maxW = WidgetBase::objTFT->textWidth(letter);
                    WidgetBase::objTFT->setTextPadding(maxW);
                    WidgetBase::objTFT->setTextColor(baseBorder, lightBg);
                    WidgetBase::objTFT->setTextDatum(MC_DATUM);
                    WidgetBase::objTFT->drawString(letter, xCenter, yCenter);
#elif defined(DISP_DEFAULT)
...
#if defined(DISP_BODMER)
    screenW = WidgetBase::objTFT->getViewportWidth();
    screenH = WidgetBase::objTFT->getViewportHeight();
#elif defined(DISP_DEFAULT)
...
#if defined(DISP_BODMER)
    WidgetBase::objTFT->setFreeFont(&Roboto_Bold10pt7b);
#elif defined(DISP_DEFAULT)
    WidgetBase::objTFT->setFont(&Roboto_Bold10pt7b);
#endif
