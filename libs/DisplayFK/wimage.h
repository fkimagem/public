...
public:
  ...
  /// @brief Detects if a touch is within the image area
  /// @param _xTouch Pointer to X coordinate of touch
  /// @param _yTouch Pointer to Y coordinate of touch
  /// @return True if touch is within image area
  bool detectTouch(uint16_t *_xTouch, uint16_t *_yTouch) override;
  
  /// @brief Gets the callback function associated with this image
  ...
  /// @brief Forces an update of the image on the next redraw cycle
  void forceUpdate();
