...
TFT_eSPI *WidgetBase::objTFT = nullptr;
...
void WidgetBase::updateFont(FontType _f)
{
    ...
    case FontType::NORMAL:
    {
        ...
        WidgetBase::objTFT->setFreeFont(WidgetBase::fontNormal);
#elif defined(DISP_DEFAULT)
...
#if defined(DISP_BODMER)
        // WidgetBase::objTFT->loadFont("FONTE15");
        WidgetBase::objTFT->setFreeFont(WidgetBase::fontBold);
#elif defined(DISP_DEFAULT)
...
#if defined(DISP_BODMER)
        // WidgetBase::objTFT->loadFont("FONTE15");
        WidgetBase::objTFT->setFreeFont(nullptr);
#elif defined(DISP_DEFAULT)
